  ...
  return (
    <div className='w-full py-6 px-3 min-h-screen bg-gray-900'>
      <div className="container mx-auto flex md:flex-row flex-col place-items-center">
        ...
        <p>It is absolutely free . And easy to use. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sunt doloremque ad dolor qui, natus quibusdam quaerat similique voluptatibus cumque totam.</p>
        <div className='mt-6'>
